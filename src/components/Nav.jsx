...
const Nav = () => {
  ...
  const menuClickHandler = () => {
    ctx.setSideNavActive(!ctx.sideNavActive);
  };
    ...
    <div className="flex justify-center fixed w-full z-50 bg-slate-950/50 backdrop-blur-lg">
      <div className="flex justify-between items-center p-2 max-w-7xl w-full">
        <Link to="home" onClick={() => ctx.scrollToSection("/home")}>
          <img src={logoPNG} width={50} alt="Bay Hacks Logo" />
        </Link>
        <div
          className={`flex gap-5 ${
            width < 850 || location.pathname.includes("/prospectus") ? "hidden" : ""
          }`}
        >
          {/* Links */}
          <Link to="about" className="hover:text-gray-400 transition-all" onClick={() => ctx.scrollToSection("/about")}>About</Link>
          <Link to="schedule" className="hover:text-blue-300 transition-all" onClick={() => ctx.scrollToSection("/schedule")}>Schedule</Link>
          <Link to="tracks" className="hover:text-blue-300 transition-all" onClick={() => ctx.scrollToSection("/tracks")}>Tracks</Link>
          <Link to="speakers" className="hover:text-blue-300 transition-all" onClick={() => ctx.scrollToSection("/speakers")}>Speakers</Link>
          <Link to="faq" className="hover:text-blue-300 transition-all" onClick={() => ctx.scrollToSection("/faq")}>FAQ</Link>
        ...
        >
          {/* Prospectus Links */}
          <Link to="prospectus/mission" className="hover:text-blue-300 transition-all" onClick={() => ctx.scrollToSection("/prospectus/mission")}>Mission</Link>
          <Link to="prospectus/perks" className="hover:text-blue-300 transition-all" onClick={() => ctx.scrollToSection("/prospectus/perks")}>Perks</Link>
          <Link to="prospectus/faq" className="hover:text-blue-300 transition-all" onClick={() => ctx.scrollToSection("/prospectus/faq")}>FAQ</Link>
          <a href="https://hcb.hackclub.com/donations/start/milpitas-hacks-2-0" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300 transition-all">Donate</a>
        </div>
        <div className="flex gap-5 items-center">
          <a target="_blank" rel="noopener noreferrer" href="https://discord.gg/RBV26FSUnc">
            {/* Discord SVG */}
          ...
          <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/bay_hacks?igsh=NTc4MTIwNjQ2YQ%3D%3D">
            {/* Instagram SVG */}
