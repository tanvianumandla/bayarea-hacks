    ...
    <div className="flex flex-col items-center bg-gradient-to-t from-primary to-primary pt-20 pb-40 pl-5 pr-5">
      ...
      <div className="pt-20 flex flex-wrap justify-center gap-10">
        ...
        <a href="https://eliteprep.com/san-jose" target="_blank">
          <img src={elitePng} className="w-54 h-44" alt="Elite Logo" style={{ marginTop: '20px' }} />
        </a>
        <a href="https://fremont.aopsacademy.org/" target="_blank">
          <img src={AoPSPng} className="w-54 h-44" alt="AoPS Logo" style={{ marginTop: '20px' }} />
        </a>
        <a href="https://www.ewave.hk/" target="_blank">
          <img src={ewavePng} className="w-96 h-44 pb-8" alt="Ewave Logo" style={{ marginTop: '20px' }} />
        </a>
        <a href="https://nextstep.com/" target="_blank">
          <img src={Nextpng} className="w-96 h-44 pb-8" alt="Next Step Logo" style={{ marginTop: '20px' }} />
        </a>
      </div>
      ...
      <div className="pt-20 flex flex-wrap justify-center gap-10">
        ...
        <a href="https://www.wolframalpha.com/" target="_blank">
          <img src={wolframalphaPng} className="w-50 h-40" alt="Wolfram Alpha Logo" style={{ marginTop: '-40px' }} />
        </a>
        <a href="https://acceptu.com/" target="_blank">
          <img src={acceptUPng} className="w-50 h-40" alt="Accept U Logo" style={{ marginTop: '-40px' }} />
        </a>
        <a href="https://gong-cha-usa.com/" target="_blank">
          <img src={GongChapng} className="w-50 h-40" alt="Gong Cha Logo" style={{ marginTop: '-40px' }} />
        </a>
        <a href="https://diya.com/" target="_blank">
          <img src={Diyapng} className="w-50 h-40" alt="Diya Logo" style={{ marginTop: '-40px' }} />
        </a>
        <a href="https://www.doingwit.org/" target="_blank">
          <img src={witpng} className="w-50 h-40" alt="WIT Logo" style={{ marginTop: '-40px' }} />
        </a>
      </div>
